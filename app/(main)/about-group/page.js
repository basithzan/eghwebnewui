...
const AboutUs = () => {
  ...
  useEffect(() => {
    ...
    ogUrlTag.setAttribute('content', seoData?.ogUrl || 'https://elitegroupholding.com/about-group');
...
canonicalLink.setAttribute('href', 'https://elitegroupholding.com/about-group');
