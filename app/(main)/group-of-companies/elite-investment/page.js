...
import mission from "/public/assets/about-us/Invest.jpg";
import ImageRakanTurki from "/public/assets/about-us/Leader.jpg";
import reward from "/public/assets/about-us/awards2.jpg";
import BackgroundImageecom from "/public/assets/about-us/BackgroundImageinvest.jpg";
...
const AboutUs = () => {
  ...
  canonicalLink.setAttribute('href', 'https://elitegroupholding.com/group-of-companies/elite-investment');
}, []);
        ...
        <div className=" absolute bottom-0 right-0 px-[5%]">
          <div className="py-5 flex items-center justify-end">
            <div className="text-[#fff]">
              <a href="">Home</a> / Group of companies / Investments
            </div>
          </div>
        </div>
      </div>
