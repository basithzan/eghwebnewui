  ...
  return (
    <div className="w-screen lg:h-[570px] xl:h-[80vh] relative flex flex-col-reverse lg:block carouselSection max-lg:py-1">
              ...
              <div className="px-5 lg:hidden flex flex-col w-full">
                ...
                >
                  <div className="bottom-0 transition-all duration-300 ease-in-out transform">
                    <div className={`select-none text-center group-hover:text-[#fb511e] whitespace-nowrap duration-300 text-[1.2rem] transition-all text-black`}>
                      {image.name}
                    </div>
                  </div>
                </Link>
        ...
        {images.map((image, index) => (
          ...
          >
            <div className="md:absolute md:w-[80%] left-1/2 md:-translate-x-1/2 md:py-4 bottom-0 transition-all duration-300 ease-in-out md:bg-[#0000007d] transform md:mb-6">
              <div className={`select-none text-center group-hover:text-[#fb511e] duration-300 sm:text-start md:px-5 text-[10px] sm:text-xs xl:text-sm 2xl:text-lg transition-all text-black md:text-white max-md:group-hover:text-white`}>
                {image.name}
              </div>
              <div className={`h-[0px] group-hover:h-[220px] xl:group-hover:h-[220px] 2xl:group-hover:h-[220px] duration-300 description max-md:hidden text-start xl:text-sm 2xl:text-base text-xs md:px-5 text-black md:text-[#DFDCDC] overflow-hidden cursor-pointer`}>
                {image.description}
                <a
                  target="_blank"
                  href={image.url}
      ...
      {/* <div className="md:hidden flex flex-col px-5">
        ...
        >
          <div className="md:absolute md:w-[80%] left-1/2 md:-translate-x-1/2 md:py-4 bottom-0 transition-all duration-300 ease-in-out md:bg-[#0000007d] transform md:mb-6">
            <div className={`select-none text-center group-hover:text-[#fb511e] whitespace-nowrap duration-300 sm:text-start md:px-5 text-[1.2rem] md:text-lg transition-all text-black md:text-white max-md:group-hover:text-white`}>
              {currentImage.name}
            </div>
            <div className={`h-0 description max-md:hidden text-start md:text-base xl:text-lg text-xs md:px-5 text-black md:text-[#DFDCDC] overflow-hidden cursor-pointer`}>
