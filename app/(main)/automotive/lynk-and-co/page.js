      ...
      <div className="px-[5%] sm:pb-10">
        <div className="md:py-5 py-2 flex items-center md:justify-end justify-center">
          <div className="text-[#282828] md:text-end text-center text-sm">
            <a href="/">Home</a> /{" "}
            <a href="/group-of-companies">Group of Companies</a> / Lynk & Co
          </div>
        </div>
        ...
        <div className="py-14 md:py-20 text-center max-w-2xl mx-auto">
          ...
          {[
            "LYNK & CO is well-known for its cutting-edge technology, Mega-City Contrast design philosophy, and commitment to redefining the automotive industry. It is a joint-venture brand co-founded by Geely and Volvo, positioning the global new premium market.   ",
            "By joining forces with this dynamic brand, we are poised to transform the driving experience for our customers and solidify our position as a leader in the market.   "
