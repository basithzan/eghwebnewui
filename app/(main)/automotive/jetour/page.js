      ...
      <div className="px-[5%] sm:pb-10">
        <div className="md:py-5 py-2 flex items-center md:justify-end justify-center">
          <div className="text-[#282828] md:text-end text-center text-sm">
            <a href="/">Home</a> /{" "}
            <a href="/group-of-companies">Group of Companies</a> / jetour
          </div>
        </div>
        ...
        <div className="py-14 md:py-20 text-center max-w-2xl mx-auto">
          ...
          {[
            ...
            "This exclusive partnership brings decades of combined formidable experience in the automotive industry, committed to deliver exceptional vehicles at very competitive prices, and professional aftersales service, ensuring complete peace of mind to our customers in the UAE",
