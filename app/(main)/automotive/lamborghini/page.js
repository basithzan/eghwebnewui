    ...
    return (
        <>
            ...
            <div className="md:h-screen h-[40vh] w-screen relative section-1">
                <Image unoptimized src={BackgroundImage} alt="fve" className="object-cover object-center h-full w-screen brightness-50" />
            ...
            <div className="px-[5%] pb-10">
                <div className="md:py-5 py-2 flex items-center md:justify-end justify-center">
                    <div className="text-[#282828] md:text-end text-center text-sm">
                        <a href="/">Home</a> / <a href="/group-of-companies">Group of Companies</a> / Lamborghini
                    </div>
                </div>

                <div className="section-spaced text-center">
                    <div className="text-2xl lg:text-6xl font-semibold mb-10 md:mt-6 mt-6 uppercase">Lamborghini</div>
                    {[
